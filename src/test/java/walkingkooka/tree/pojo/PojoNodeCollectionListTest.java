...
public final class PojoNodeCollectionListTest extends PojoNodeCollectionTestCase<PojoNodeCollectionList, List<Object>> {
    ...
    public void testSetChildrenIncorrectIndiciesIgnored() {
        final PojoNodeCollectionList node = this.createPojoNode();
    ...
    public void testSetChildrenImmutableChildWithParent() {
        ...
        this.checkEquals(new TestImmutableParent(children2), parentNode2.value(), "parentNode2.value");
    }
    ...
    public void testSetChildrenMutableChildWithParent() {
        ...
        this.childrenValuesCheck(parentNode2, Lists.of(children2));
        this.checkEquals(new TestMutableParent(children2), parentNode2.value(), "parentNode2.value");
    }
    ...
    public void testSetChildrenValuesImmutableChildWithParent() {
        ...
        this.checkEquals(new TestImmutableParent(Lists.of(child2)), parentNode2.value(), "parentNode2.value");
    }
    ...
    public void testSetChildrenValuesMutableChildWithParent() {
        ...
        assertSame(parentNode, parentNode2);
        this.childrenValuesCheck(parentNode2, Lists.of(Lists.of(child2)));
        this.checkEquals(new TestMutableParent(Lists.of(child2)), parentNode2.value(), "parentNode2.value");
    }
    ...
    @Override
    PojoNodeCollectionList createEmptyPojoNode() {
        return this.createPojoNode(Lists.empty());
    }

    @Override
    PojoNodeCollectionList createPojoNode() {
    ...
    @Override
    List<PojoNode> children(final PojoNodeCollectionList firstNode) {
        return this.children0(firstNode, ELEMENT0, ELEMENT1);
    }

    @Override
    List<PojoNode> differentChildren(final PojoNodeCollectionList firstNode) {
        return this.children0(firstNode, ELEMENT0);
    }

    private List<PojoNode> children0(final PojoNodeCollectionList firstNode, final Object... values) {
    ...
    @Override
    Class<PojoNodeCollectionList> pojoNodeType() {
        return PojoNodeCollectionList.class;
    }
